-- Argus initial schema. Driver-agnostic SQL (SQLite dialect; Postgres adapter translates at apply-time).
-- RULE: every table carries tenant_id and is indexed on (tenant_id, ...).
